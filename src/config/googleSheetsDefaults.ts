...
export const GOOGLE_SHEETS_DEFAULTS = {
  ...
  webappUrl: 'https://script.google.com/macros/s/AKfycbyf8O6efy6uYfnV4PKKETQ3mhb9cVgwAelk0m06L2IEyWIVd0tEOjdPFsxAN34e5Wk-xg/exec', // Google Apps Script Web App URL
};
