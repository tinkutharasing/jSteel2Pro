...
export const GOOGLE_SHEETS_DEFAULTS = {
  ...
  webappUrl: 'https://script.google.com/macros/s/AKfycbyFAC6wEi6_6pjWiQ327SdHzwLxafJ_ytbST7c0FNhjdkJGRT1Hn9Rc65mjajioyNvU6g/exec', // Google Apps Script Web App URL
};
