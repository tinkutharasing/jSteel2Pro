...
export const GOOGLE_SHEETS_DEFAULTS = {
  ...
  webappUrl: 'https://script.google.com/macros/s/AKfycbz_Z0A8SoInPPv1E-atZd1K_6bpj0g_-nAYRu1k0W4nzEB-il2XeuPwk3FOat0QZkOUnQ/exec', // Google Apps Script Web App URL
};
