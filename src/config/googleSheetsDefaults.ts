...
export const GOOGLE_SHEETS_DEFAULTS = {
  ...
  webappUrl: 'https://script.google.com/macros/s/AKfycbyYqZxD5KfZjcuazPUrEugYaWRq7EcrK8P0eft3f0rpp1L46eW44KO3SEDtFoENrKXeMg/exec', // Google Apps Script Web App URL - BUG FIXED VERSION
};
